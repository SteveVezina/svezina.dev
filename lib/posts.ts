export type PostMeta={slug:string;title:string;description:string;date:string;status:string;tags:string[];thumbnail:string;readingMinutes:number}; export type Post={meta:PostMeta;source:string};
